...
class BaseResource extends JsonResource
{
    ...
    public const REQUEST_INCLUDE_EMPTY_RELATIONS = 'includeEmptyRelations';
    ...
    protected bool $includeEmptyRelations = true;
    ...
    public function setIncludeEmptyRelations()
    {
        if (request(self::REQUEST_INCLUDE_EMPTY_RELATIONS) == "false")
        {
            $this->includeEmptyRelations = false;
        }
    }
    ...
    public function getResource(): array
    {
        ...
        $response = $this->withoutRelation ? $this->getAttributesWithRelations($data) : $data;
    ...
    private function clearResponse($response): array
    {
